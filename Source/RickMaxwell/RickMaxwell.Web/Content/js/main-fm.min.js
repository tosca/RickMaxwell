...
"easeInOutQuart");$(".supersized-nav").fadeIn(500,"easeInOutQuart")}else{$("#supersized").show().css({"opacity":1});$("#superNav").show();}if(self.superSlider&&defaults.homeSliderThumbnail)api.min_thumb()}if(!self.mobile){self.pageHeader.fadeIn(500,"easeInOutQuart");$(".homeSlider").fadeIn(500,"easeInOutQuart")}else{self.pageHeader.show();$(".homeSlider").show()}if(!self.onePage){$("body").find(".addVideo").each(function(){var vid=$(this);var kk=false;$(this).find("img").each(function(){kk=
